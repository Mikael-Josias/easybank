...
export default function Header() {
  ...
  return (
    <header className="w-full h-20 fixed top-0 bg-white z-10">
      <div className="flex items-center justify-between lg:w-full xl:w-[1200px] px-10 xl:px-0 m-auto h-full">
        <Image src={Logo} alt="Easybank logo"/>
        <nav className="flex h-full bg-gradient-to-r from-lime-green to-bright-cyan collapse lg:visible">
        ...
        <RequestInviteButton collapse={'collapse lg:visible'}/>
